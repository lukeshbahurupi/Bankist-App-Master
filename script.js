...
const account4 = {
  owner: "Sachin Kumar Sharma",
  movements: [430, 1000, 700, 50, 90, 5000, 10000, 23000],
  interestRate: 1,
  pin: 4444,
...
btnLoan.addEventListener("click", function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    ...
    alert("You'r not eligible for loan!");
  }
